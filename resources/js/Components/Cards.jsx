...
function Card({TicketsIndex, totalTickets, openTickets, inProgressTickets, closedTickets }) {
    ...
    return (
        <>
<div className="flex flex-wrap lg:flex-nowrap w-full mb-3 gap-4">
    <div className="block bg-white w-full sm:w-1/2 lg:w-1/4 h-auto p-5 rounded-lg border-2 drop-shadow-lg border-slate-200">
    ...
    <div className="block bg-white w-full sm:w-1/2 lg:w-1/4 h-auto p-5 rounded-lg border-2 drop-shadow-lg border-slate-200">
        ...
        <div className="text-slate-500">+{tCerrados}% del total de tickets</div>
    </div>
</div>
