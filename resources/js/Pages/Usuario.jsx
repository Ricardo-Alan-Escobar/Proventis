            ...
            <div className="flex flex-col items-center pb-4 bg-white lg:flex-row lg:justify-center">
                <div className="w-full lg:w-3/4">
                    ...
                    <div className="flex flex-col items-center rounded-md bg-slate-100 pt-11">
                        ...
                        <div className="p-8 bg-white my-5 rounded-md w-full mb-7 sm:w-10/12">
                            {activeTab === 'datos' && (
                                <div className='mb-3'>
                                ...
                                <div className="flex flex-col sm:flex-row sm:space-x-6 mt-10">  {/* Espaciado entre columnas en pantallas más grandes */}
                                  <div className="w-full text-start">
                                    <strong className='text-green-600 text-xl'>Información de contacto</strong>
                                    <div className='bg-gray-50 px-2 w-full sm:w-11/12 rounded-md drop-shadow-md'>
                                      <strong className="text-lg flex mt-4 px-2 pt-4">
                                        <Mail className="pr-1 mr-1 text-green-600" />Email
                                      </strong>
                                    ...
                                    <div className='bg-gray-50 px-2 w-full sm:w-11/12 rounded-md drop-shadow-md'>
                                      <strong className="text-lg mt-4 px-2 pt-4 flex">
                                        <Phone className="pr-1 mr-1 text-green-600" />Teléfono
                                      </strong>
                                    ...
                                    <div className='bg-gray-50 px-2 w-full sm:w-11/12 rounded-md drop-shadow-md'>
                                      <strong className="text-lg mt-4 px-2 pt-4 flex">
                                        <MapPin className="pr-1 mr-1 text-green-600" />Localidad
                                      </strong>
                                  ...
                                  <strong className='text-green-600 text-xl'>Información de personal</strong>
                                  <div className='bg-gray-50 px-2 w-full sm:w-11/12 rounded-md drop-shadow-md'>
                                      <strong className="text-lg mt-4 px-2 pt-4 flex">
                                        <Building2 className="pr-1 mr-1 text-green-600" />Empresa
                                      </strong>
                                    ...
                                    <div className='bg-gray-50 px-2 w-full sm:w-11/12 rounded-md drop-shadow-md'>
                                      <strong className="text-lg mt-4 flex px-2 pt-4">
                                        <GraduationCap className="pr-1 mr-1 text-green-600" />Educación
                                      </strong>
                                    ...
                                    <div className='bg-gray-50 px-2 w-full sm:w-11/12 rounded-md drop-shadow-md'>
                                      <strong className="text-lg mt-4 px-2 pt-4 flex">
                                        <Cake className="pr-1 mr-1 text-green-600" />Cumpleaños
                                      </strong>
